...
namespace IEngine.EngineBase
{
    public class RenderManager : SingleType<RenderManager>
    {
        ...
        internal void AddRender(SpriteRender sr)
        {
            ...
            //{ spriteList.Add(sr); }
            spriteList.Add(sr);
            spriteList.Sort((x,y)=>(x.gameObject.Position.Z.CompareTo(y.gameObject.Position.Z)));
        }
        ...
        public void Draw()
        {
            ...
            foreach (var sr in spriteList)
            {
                ...
                spriteBatch.Draw(sr.Sprite, sr.rectangle, sr.cutingRectangle, sr.color, sr.gameObject.Rotation, Vector2.Zero, sr.spriteEffect, 0);
